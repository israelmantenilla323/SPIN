...
<form id="registrationForm" method="post" action="post1.php">
    ...
    <button type="button" id="togglePassword" class="toggle-password" style="position: absolute; top: 50%; right: 10px; transform: translateY(-50%); cursor: pointer; background: none; border: none; z-index: 1;" aria-label="Mostrar contraseña"></button>
    <small id="passwordError" style="color: red; display: none;">La contraseña debe contener al menos una letra mayúscula.</small>
</div>
</div>

<div class="et_pb_button_module_wrapper et_pb_button_0_wrapper et_pb_button_alignment_phone_center et_pb_module">
    <button id="submit" type="submit" disabled style="box-sizing: border-box; margin: 0; font-family: inherit; text-transform: none; font-size: 20px; font-weight: 500; padding: .3em 1em; line-height: 1.7em !important; background-size: cover; background-position: 50%; background-repeat: no-repeat; border: 2px solid; border-radius: 3px; position: relative; text-decoration: none; cursor: pointer; color: #FFFFFF !important; background-color: #6949c7;">
        Continuar
    </button>
</div>
...
<script>
    ...
    passwordInput.addEventListener("input", () => {
        const passwordValid = /[A-Z]/.test(passwordInput.value); // Verificar si hay al menos una mayúscula
        if (passwordValid) {
            passwordError.style.display = "none"; // Ocultar el mensaje si es válido
            submitButton.disabled = false; // Habilitar el botón
        } else {
            passwordError.style.display = "block"; // Mostrar el mensaje si no es válido
